...
window.BOOK_DATA = {
  ...
  castSections: [
    ...
    { id: "sevrin", name: "Sevrin", realm: "Fulgur" },
    ...
    { id: "draevin", name: "Draevin", realm: "Fulgur" },
    { id: "veyron", name: "Veyron", realm: "Fulgur" },
    { id: "veyra", name: "Veyra", realm: "Gélidos" },
    { id: "korr", name: "Korr", realm: "Gélidos" },
    { id: "noche", name: "La noche eterna" },
    { id: "dia", name: "El día eterno" },
  ...
  groups: [
    ...
    { id: "madres", name: "Las dos madres", file: "assets/personajes/las-dos-madres.webp", w: 1600, h: 1431, unlock: 36, section: "dia",
  ...
  characters: [
    ...
    { id: "scar", name: "Scar", file: "assets/personajes/scar.webp", w: 900, h: 1350, unlock: 16, section: "noche" },
    { id: "arlette", name: "Arlette Voss", file: "assets/personajes/arlette-voss.webp", w: 900, h: 1350, unlock: 26, section: "cam17" },
    { id: "maelis", name: "Maelis Varen", file: "assets/personajes/maelis-varen.webp", w: 900, h: 1350, unlock: 36, section: "dia" },
    ...
    { id: "ilyra", name: "Ilyra Aurelian", file: "assets/personajes/ilyra-aurelian.webp", w: 900, h: 1350, unlock: 36, section: "dia" },
    ...
    { id: "cassian", name: "Cassian Sevrin", file: "assets/personajes/cassian-sevrin.webp", w: 900, h: 1350, unlock: 11, section: "sevrin" },
    ...
    { id: "coris", name: "Coris", file: "assets/personajes/coris.webp", w: 900, h: 1350, unlock: 12, section: "korr" },
    { id: "nhalia", name: "Nhalia Veyra", file: "assets/personajes/nhalia-veyra.webp", w: 900, h: 1350, unlock: 13, section: "veyra" },
    { id: "loras", name: "Loras Corven", file: "assets/personajes/loras-corven.webp", w: 900, h: 1350, unlock: 12, section: "corven" },
    { id: "averian", name: "Averian Vaelor", file: "assets/personajes/averian-vaelor.webp", w: 900, h: 1350, unlock: 23, section: "noche" },
    ...
    { id: "aldren", name: "Aldren Soryn", epithet: "El Heredero de la Luna Bélica", file: "assets/personajes/aldren-soryn.webp", w: 900, h: 1350, unlock: 23, section: "noche" },
    { id: "yseva", name: "Yseva Soryn", epithet: "La Astrónoma de la Guerra", file: "assets/personajes/yseva-soryn.webp", w: 900, h: 1350, unlock: 31, section: "noche" },
    { id: "hastir", name: "Hastir Soryn", epithet: "La Garra Carmesí", file: "assets/personajes/hastir-soryn.webp", w: 900, h: 1350, unlock: 31, section: "noche" },
    ...
    { id: "rask", name: "Rask", file: "assets/personajes/rask.webp", w: 900, h: 1350, unlock: 25, section: "dia" },
    { id: "hal", name: "Hal'Verkan", file: "assets/personajes/hal-verkan.webp", w: 900, h: 1350, unlock: 30, section: "dia" },
    { id: "dravik", name: "Dra'Vik", file: "assets/personajes/dravik.webp", w: 900, h: 1350, unlock: 30, section: "dia" },
    { id: "bryn", name: "Bryn'Veth", file: "assets/personajes/bryn-veth.webp", w: 900, h: 1350, unlock: 30, section: "dia" },
    { id: "tor", name: "Tor'Vaer", file: "assets/personajes/tor-vaer.webp", w: 900, h: 1350, unlock: 30, section: "dia" },
    { id: "yorn", name: "Yorn'Taz", file: "assets/personajes/yorn-taz.webp", w: 900, h: 1350, unlock: 30, section: "dia" }
  ],
  ...
  chapters: [
    { number: 1, title: "El héroe de CAM-17", part: "Parte I", file: "01-el-heroe-de-cam-17.mp3", seconds: 2352 },
    ...
    { number: 4, title: "Bajo custodia", part: "Parte I", file: "04-bajo-custodia.mp3", seconds: 2692 },
    { number: 5, title: "Rutas de salida", part: "Parte I", file: "05-rutas-de-salida.mp3", seconds: 2287 },
    { number: 6, title: "Antes que termine el día", part: "Parte I", file: "06-antes-que-termine-el-dia.mp3", seconds: 2724 },
    { number: 7, title: "El rescate", part: "Parte I", file: "07-el-rescate.mp3", seconds: 2520 },
    { number: 8, title: "Demasiado fuerte", part: "Parte I", file: "08-demasiado-fuerte.mp3", seconds: 1295 },
    { number: 9, title: "Del otro lado del Muro", part: "Parte II", file: "09-del-otro-lado-del-muro.mp3", seconds: 3501 },
    { number: 10, title: "El laboratorio", part: "Parte II", file: "10-el-laboratorio.mp3", seconds: 3027 },
    ...
    { number: 16, title: "Hielo Rojo", part: "Parte II", file: "16-hielo-rojo.mp3", seconds: 1467 },
    ...
    { number: 21, title: "Lo que aprendieron", part: "Parte III", file: "21-lo-que-aprendieron.mp3", seconds: 1752 },
    { number: 22, title: "Reencuentro", part: "Parte III", file: "22-reencuentro.mp3", seconds: 974 },
    { number: 23, title: "Una fecha inventada", part: "Parte III", file: "23-una-fecha-inventada.mp3", seconds: 1747 },
    { number: 24, title: "Donde no anochece", part: "Parte III", file: "24-donde-no-anochece.mp3", seconds: 1930 },
    ...
    { number: 27, title: "Bajo el sol eterno", part: "Parte IV", file: "27-bajo-el-sol-eterno.mp3", seconds: 1056 },
    { number: 28, title: "Hasta aquí", part: "Parte IV", file: "28-hasta-aqui.mp3", seconds: 1327 },
    { number: 29, title: "Cuarenta y siete", part: "Parte IV", file: "29-cuarenta-y-siete.mp3", seconds: 1523 },
    ...
    { number: 31, title: "Los hermanos", part: "Parte IV", file: "31-los-hermanos.mp3", seconds: 1042 },
    { number: 32, title: "Daños colaterales", part: "Parte IV", file: "32-danos-colaterales.mp3", seconds: 1521 },
    ...
    { number: 35, title: "Huellas", part: "Parte IV", file: "35-huellas.mp3", seconds: 930 },
    { number: 36, title: "Las dos madres", part: "Parte IV", file: "36-las-dos-madres.mp3", seconds: 1941 },
    { number: 37, title: "Guerras de humanos", part: "Parte IV", file: "37-guerras-de-humanos.mp3", seconds: 1265 },
    { number: 38, title: "Por la espalda", part: "Parte IV", file: "38-por-la-espalda.mp3", seconds: 1837 },
    { number: 39, title: "¿Cuáles?", part: "Parte IV", file: "39-cuales.mp3", seconds: 2248 },
    { number: 103, label: "Interludio III", badge: "III", title: "Los nombres", part: "Parte IV", file: "39b-interludio-iii-los-nombres.mp3", seconds: 172 },
    { number: 40, title: "Demasiado importante", part: "Parte IV", file: "40-demasiado-importante.mp3", seconds: 2877 },
    { number: 41, title: "Sin retorno", part: "Parte IV", file: "41-sin-retorno.mp3", seconds: 1916 },
    { number: 42, title: "Shuren", part: "Parte IV", file: "42-shuren.mp3", seconds: 1732 }
  ]
};
